...
public class PatientController {
	...
	@GetMapping("/patient/docvisit/{id}")
	public List<Patient> getAllpatientbydoc(@PathVariable Integer id){
		return patient.getAllPatientBasedOnDoc(id);
	}
	...
	public OutputPatientAndTheirInfo getVisits(@PathVariable Integer id){
